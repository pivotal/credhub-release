...
1. Install CredHub CLI:
  ...
  CredHub CLI offers a simple interface to manage credentials and CAs. You can download the [latest release here.](https://github.com/cloudfoundry-incubator/credhub-cli/releases)
